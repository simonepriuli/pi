...
export type RpcResponse =
	...
	| { id?: string; type: "response"; command: "fork_at_entry"; success: true; data: { cancelled: boolean } }
	...
	| {
			id?: string;
			type: "response";
			command: "get_messages_with_entry_ids";
			success: true;
			data: { messages: Array<AgentMessage & { entryId?: string }> };
	  }
